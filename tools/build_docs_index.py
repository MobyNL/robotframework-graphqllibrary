...
DOCUMENT = "GraphQLLibraryKeywords.html"
...
<title>GraphQLLibrary keyword documentation</title>
<style>
...
<body>
<h1>GraphQLLibrary</h1>
<p class="lead">Keyword documentation, per released version.</p>
<ul>
{entries}
</ul>
<footer>
<p>The library is below 1.0.0, so the keyword surface can still change between releases.
Read the page for the version you have installed; the
<a href="https://github.com/MobyNL/robotframework-graphqllibrary/blob/main/CHANGELOG.md">changelog</a>
records what changed.</p>
<p><a href="https://github.com/MobyNL/robotframework-graphqllibrary">Source on GitHub</a></p>
</footer>
</body>
</html>
"""
